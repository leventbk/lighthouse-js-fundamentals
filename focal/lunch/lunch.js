...
const whatToDoForLunch = function(hungry, availableTime) {
  if (!hungry) {
    ...
    console.log('we want to remind ourselves that we are in a bootcamp and that we should reconsider how much time we actually have to spare');
  }
 ...
 * defied above to verify we're making the right decisions. Do not modify it!
 */
